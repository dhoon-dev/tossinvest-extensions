...
description: Repository-specific workflow for creating Git commits in tossinvest-extensions. Use when the user asks Codex to commit changes, stage files, write a commit message, amend a commit, or verify commit-message compliance in this repo.
---
